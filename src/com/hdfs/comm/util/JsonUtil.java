...
public class JsonUtil {
	...
	public static List toList(Object object, Class objectClass) {
		if (object instanceof JSONArray) {
			return (List) JSONArray.toCollection((JSONArray) object,
					objectClass);
		} else {
	...
	public static void main(String[] args) {
		...
		// 鍙栧埌闆嗗悎瀵硅薄
		// List<User> userList = JsonUtil.toList(map.get("userList"),
		// com.aspire.community.cbp.domain.profile.dto.User.class);
		...
		//
		// String
		// jsonStr="{\"userId\":\"34545\",\"mobileList\":{\"2\":\"b\",\"1\":\"a\"}}";
		// mapa=toMap(jsonStr);
